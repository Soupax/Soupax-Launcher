...
Si vous téléchargez à partir des Releases, sélectionnez le programme d'installation de votre système.
 ...
 Plateforme | Fichier |
| -------- | ---- |
| Windows x64 | `Soupax-Launcher-win-x64.exe ` |
| macOS x64 | `Soupax-Launcher-mac-x64.dmg` |
| macOS arm64 | `Soupax-Launcher-mac-arm64.dmg` |
| Linux x64 | `Soupax-Launcher-linux-x86_64.AppImage` |
